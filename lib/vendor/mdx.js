...
var require_acorn = __commonJS({
  "node_modules/acorn/dist/acorn.js"(exports, module2) {
    (function(global, factory2) {
      typeof exports === "object" && typeof module2 !== "undefined" ? factory2(exports) : typeof define === "function" && define.amd ? define(["exports"], factory2) : (global = global || self, factory2(global.acorn = {}));
      ...
      pp$12.parseBlock = function(createNewLexicalScope, node) {
      ...
      pp$32.parseMaybeAssign = function(noIn, refDestructuringErrors, afterLeftParse) {
        ...
        if (this.type.isAssign) {
          ...
          if (!ownDestructuringErrors) {
            DestructuringErrors2.call(refDestructuringErrors);
          }
      ...
      pp$32.parseSubscripts = function(base2, startPos, startLoc, noCalls) {
        var maybeAsyncArrow = this.options.ecmaVersion >= 8 && base2.type === "Identifier" && base2.name === "async" && this.lastTokEnd === base2.end && !this.canInsertSemicolon() && this.input.slice(base2.start, base2.end) === "async";
        while (true) {
          var element2 = this.parseSubscript(base2, startPos, startLoc, noCalls, maybeAsyncArrow);
      ...
      pp$32.parseSubscript = function(base2, startPos, startLoc, noCalls, maybeAsyncArrow) {
        ...
        if (computed || this.eat(types2.dot)) {
          ...
          this.awaitPos = 0;
          this.awaitIdentPos = 0;
          var exprList = this.parseExprList(types2.parenR, this.options.ecmaVersion >= 8 && base2.type !== "Import", false, refDestructuringErrors);
      ...
      pp$32.parseDynamicImport = function() {
        var node = this.startNode();
        this.next();
      ...
      var RegExpValidationState3 = function RegExpValidationState4(parser) {
        ...
        this.unicodeProperties = data3[parser.options.ecmaVersion >= 11 ? 11 : parser.options.ecmaVersion];
        this.source = "";
        this.flags = "";
        this.start = 0;
        this.switchU = false;
      ...
      RegExpValidationState3.prototype.at = function at2(i) {
        var s = this.source;
        var l = s.length;
        if (i >= l) {
          return -1;
      ...
      RegExpValidationState3.prototype.nextIndex = function nextIndex2(i) {
        var s = this.source;
        var l = s.length;
        if (i >= l) {
          return l;
      ...
      RegExpValidationState3.prototype.current = function current2() {
        return this.at(this.pos);
      };
      RegExpValidationState3.prototype.lookahead = function lookahead2() {
        return this.at(this.nextIndex(this.pos));
      };
      RegExpValidationState3.prototype.advance = function advance2() {
        this.pos = this.nextIndex(this.pos);
      };
      RegExpValidationState3.prototype.eat = function eat2(ch) {
        if (this.current() === ch) {
          this.advance();
          return true;
        }
      ...
      pp$82.regexp_eatRegExpUnicodeEscapeSequence = function(state) {
        var start3 = state.pos;
        if (state.eat(117)) {
          ...
          if (state.switchU && state.eat(123) && this.regexp_eatHexDigits(state) && state.eat(125) && isValidUnicode2(state.lastIntValue)) {
            return true;
          }
          if (state.switchU) {
            state.raise("Invalid unicode escape");
      ...
      pp$92.getTokenFromCode = function(code2) {
        ...
        this.raise(this.pos, "Unexpected character '" + codePointToString$12(code2) + "'");
      };
      ...
      pp$92.readInt = function(radix, len) {
        var start3 = this.pos, total = 0;
      ...
      pp$92.readRadixNumber = function(radix) {
        ...
        if (this.options.ecmaVersion >= 11 && this.input.charCodeAt(this.pos) === 110) {
          val = typeof BigInt !== "undefined" ? BigInt(this.input.slice(start3, this.pos)) : null;
          ++this.pos;
      ...
      pp$92.readNumber = function(startsWithDot) {
        ...
        if (!octal && !startsWithDot && this.options.ecmaVersion >= 11 && next === 110) {
          var str$1 = this.input.slice(start3, this.pos);
        ...
        var str = this.input.slice(start3, this.pos);
      ...
      function codePointToString$12(code2) {
        if (code2 <= 65535) {
...
function visit(tree, visitor) {
  ...
  function build(node, key, index2, parents) {
    if (nodelike(node)) {
      visit5.displayName = "node (" + color(node.type) + ")";
    }
    return visit5;
    function visit5() {
...
function eventsToAcorn(events, options) {
  ...
  if (estree) {
    ...
    visit(estree, (esnode, field, index3, parents) => {
      ...
      const pointStart3 = parseOffsetToUnistPoint(esnode.start);
      const pointEnd3 = parseOffsetToUnistPoint(esnode.end);
      esnode.start = pointStart3.offset;
      esnode.end = pointEnd3.offset;
      esnode.loc = {
        start: {
          line: pointStart3.line,
          column: pointStart3.column - 1
        },
        end: {
          line: pointEnd3.line,
          column: pointEnd3.column - 1
        }
      };
...
function factoryTag(effects, ok3, nok, acorn, acornOptions, addResult, allowLazy, tagType, tagMarkerType, tagClosingMarkerType, tagSelfClosingMarker, tagNameType, tagNamePrimaryType, tagNameMemberMarkerType, tagNameMemberType, tagNamePrefixMarkerType, tagNameLocalType, tagExpressionAttributeType, tagExpressionAttributeMarkerType, tagExpressionAttributeValueType, tagAttributeType, tagAttributeNameType, tagAttributeNamePrimaryType, tagAttributeNamePrefixMarkerType, tagAttributeNameLocalType, tagAttributeInitializerMarkerType, tagAttributeValueLiteralType, tagAttributeValueLiteralMarkerType, tagAttributeValueLiteralValueType, tagAttributeValueExpressionType, tagAttributeValueExpressionMarkerType, tagAttributeValueExpressionMarkerValue) {
  ...
  function beforeAttribute(code2) {
    ...
    if (code2 === 123) {
      return factoryMdxExpression.call(self2, effects, afterAttributeExpression, tagExpressionAttributeType, tagExpressionAttributeMarkerType, tagExpressionAttributeValueType, acorn, acornOptions, addResult, true, false, allowLazy)(code2);
    }
    if (code2 !== null && start2(code2)) {
  ...
  function beforeAttributeValue(code2) {
    ...
    if (code2 === 123) {
      return factoryMdxExpression.call(self2, effects, afterAttributeValueExpression, tagAttributeValueExpressionType, tagAttributeValueExpressionMarkerType, tagAttributeValueExpressionMarkerValue, acorn, acornOptions, addResult, false, false, allowLazy)(code2);
    }
  ...
  function optionalEsWhitespace(code2) {
    if (markdownLineEnding(code2)) {
      ...
      return effects.attempt(lazyLineEnd, optionalEsWhitespace, crashEol)(code2);
    }
  ...
  function crash(code2, at2, expect) {
    throw new VFileMessage("Unexpected " + (code2 === null ? "end of file" : "character `" + (code2 === 96 ? "` ` `" : String.fromCharCode(code2)) + "` (" + serializeCharCode(code2) + ")") + " " + at2 + ", expected " + expect, self2.now(), "micromark-extension-mdx-jsx:unexpected-" + (code2 === null ? "eof" : "character"));
  }
}
...
function tokenizeHtmlFlow(effects, ok3, nok) {
  ...
  function open(code2) {
    ...
    if (asciiAlpha(code2)) {
      effects.consume(code2);
      buffer4 = String.fromCharCode(code2);
      startTag = true;
      return tagName;
    }
    return nok(code2);
  ...
  function cdataOpenInside(code2) {
    if (code2 === buffer4.charCodeAt(index2++)) {
      effects.consume(code2);
      return index2 === buffer4.length ? self2.interrupt ? ok3 : continuation : cdataOpenInside;
    }
    return nok(code2);
  }
  ...
  function tagName(code2) {
    if (code2 === null || code2 === 47 || code2 === 62 || markdownLineEndingOrSpace(code2)) {
      if (code2 !== 47 && startTag && htmlRawNames.includes(buffer4.toLowerCase())) {
        kind = 1;
  ...
  function continuationRawEndTag(code2) {
    if (code2 === 62 && htmlRawNames.includes(buffer4.toLowerCase())) {
      effects.consume(code2);
      return continuationClose;
    }
    if (asciiAlpha(code2) && buffer4.length < 8) {
      effects.consume(code2);
      buffer4 += String.fromCharCode(code2);
      return continuationRawEndTag;
    }
...
function tokenizeHtmlText(effects, ok3, nok) {
  ...
  function cdataOpen(code2) {
    if (code2 === buffer4.charCodeAt(index2++)) {
      effects.consume(code2);
      return index2 === buffer4.length ? cdata : cdataOpen;
    }
    return nok(code2);
  }
  ...
  function tokenizeExportImport(effects, ok3, nok) {
    ...
    function start3(code2) {
      if (self2.now().column > 1)
        return nok(code2);
      buffer4 = code2 === 101 ? "export" : "import";
    ...
    function keyword(code2) {
      if (code2 === buffer4.charCodeAt(index2++)) {
        effects.consume(code2);
        return index2 === buffer4.length ? after : keyword;
      }
      return nok(code2);
    }
    function after(code2) {
...
function preprocess() {
  ...
  function preprocessor(value, encoding, end) {
    ...
    let endPosition;
    let code2;
    value = buffer4 + value.toString(encoding);
    startPosition = 0;
    buffer4 = "";
    if (start3) {
    ...
    while (startPosition < value.length) {
      ...
      if (!match) {
        buffer4 = value.slice(startPosition);
        break;
      }
...
function compiler(options = {}) {
  const config = configure({
    ...
    enter: {
      ...
      htmlFlow: opener(html4, buffer4),
      htmlFlowData: onenterdata,
      htmlText: opener(html4, buffer4),
...
function unknown(h, node) {
  ...
  if ("value" in node && !(own7.call(data3, "hName") || own7.call(data3, "hProperties") || own7.call(data3, "hChildren"))) {
...
// node_modules/remark-rehype/node_modules/unist-util-visit-parents/color.js
function color2(d) {
  return "[33m" + d + "[39m";
}
...
// node_modules/remark-rehype/node_modules/mdast-util-definitions/node_modules/unist-util-visit-parents/color.js
function color3(d) {
  return "[33m" + d + "[39m";
}
...
function table(h, node) {
  ...
  while (++index2 < rows.length) {
    ...
    while (pos--) {
      const cell = row[pos];
      out[pos] = h(cell, name2, { align: align[pos] }, cell ? all2(h, cell) : []);
    }
  ...
  function augment(left, right) {
    if (left && "data" in left && left.data) {
      ...
      if (right.type === "element" && data3.hProperties) {
        right.properties = { ...right.properties, ...data3.hProperties };
      }
...
var toIdOrMemberExpression = toIdOrMemberExpressionFactory("Identifier", "MemberExpression");
var toJsxIdOrMemberExpression = toIdOrMemberExpressionFactory("JSXIdentifier", "JSXMemberExpression");
function toIdOrMemberExpressionFactory(idType, memberType) {
  ...
  function toIdOrMemberExpression2(ids) {
    ...
    while (++index2 < ids.length) {
      ...
      const id = typeof name2 === "string" && name(name2) ? { type: idType, name: name2 } : { type: "Literal", value: name2 };
      object = object ? {
        type: memberType,
        object,
        property: id,
...
// node_modules/hast-util-to-estree/node_modules/unist-util-position/index.js
var pointStart2 = point3("start");
var pointEnd2 = point3("end");
function position2(node) {
  return { start: pointStart2(node), end: pointEnd2(node) };
}
...
// node_modules/@mdx-js/mdx/node_modules/unist-util-is/index.js
...
// node_modules/@mdx-js/mdx/node_modules/unist-util-visit-parents/color.js
function color4(d) {
  return "[33m" + d + "[39m";
}

// node_modules/@mdx-js/mdx/node_modules/unist-util-visit-parents/index.js
var CONTINUE4 = true;
var SKIP4 = "skip";
var EXIT4 = false;
var visitParents3 = function(tree, test, visitor, reverse) {
  ...
  function factory2(node, index2, parents) {
    ...
    if (typeof value.type === "string") {
      name2 = typeof value.tagName === "string" ? value.tagName : typeof value.name === "string" ? value.name : void 0;
      Object.defineProperty(visit5, "name", {
        value: "node (" + color4(value.type + (name2 ? "<" + name2 + ">" : "")) + ")"
      });
    }
    return visit5;
    function visit5() {
...
function rehypeRemoveRaw() {
  return (tree) => {
    visit4(tree, "raw", (_, index2, parent) => {
...
function remarkMarkAndUnravel() {
  return (tree) => {
    visit4(tree, (node, index2, parent_) => {
...
// de_modules/@mdx-js/mdx/lib/condition.js
var import_node_process = __toESM(require("process"), 1);
var development = import_node_process.default.env.NODE_ENV === "development";
...
var proc2 = import_process2.default;
...
var VFile2 = class {
  constructor(value) {
    ...
    if (!value) {
      options = {};
    } else if (typeof value === "string" || (0, import_is_buffer3.default)(value)) {
      options = { value };
  ...
  set path(path3) {
    if (isUrl2(path3)) {
      path3 = (0, import_url3.fileURLToPath)(path3);
    }
...
function resolveFileAndOptions(vfileCompatible, options) {
  const file = looksLikeAVFile2(vfileCompatible) ? vfileCompatible : new VFile2(vfileCompatible);
